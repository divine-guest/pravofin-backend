...
@app.get("/")
def root():
    return {"message": "ПравоФин API работает с YandexGPT", "status": "ok"}

# === ГЕНЕРАЦИЯ ДОКУМЕНТА С YANDEXGPT ===
@app.post("/generate")
...
Включи все необходимые реквизиты: дату, место, стороны, предмет, сроки, ответственность, подписи.
"""
        ...
        payload = {
            ...
            "messages": [
                {"role": "system", "text": "Ты — профессиональный юрист. Составляешь юридические документы."},
